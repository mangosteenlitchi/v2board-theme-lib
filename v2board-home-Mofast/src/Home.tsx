  ...
  return (
    <>
          ...
          <div className={styles.header_container}>
            ...
            <div className={styles.header_link}>
              <Button
                variant="outlined"
                onClick={() => {
                  window.open('https://google.com', '_self'); // 此处修改 登入 跳转链接
                }}>
                登入
              </Button>
              <Button
                ...
                disableElevation
                onClick={() => {
                  window.open('https://google.com', '_self'); // 此处修改 注册 跳转链接
                }}>
                注册
              </Button>
            </div>
      ...
      <main>
        ...
        <footer>
          <a href="https://google.com" target="_self" >服务条款</a> @2021 Mofast.Cloud. version 0.1.7 dev
        </footer>
      </main>
    </>
  );
